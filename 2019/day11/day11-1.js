...
class Hull {
  ...
  getCurrentColor() {
    ...
    // return this.hull[y][x] === COLOR_BLACK.VALUE ? COLOR_BLACK.REPR : COLOR_WHITE.REPR
  }
...
async function main(input) {
  ...
  return Object.keys(panelsVisited).length
}
